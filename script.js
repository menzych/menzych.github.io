...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('trigger-tg').addEventListener('click', () => triggerAchievement(2));
    document.getElementById('trigger-steam').addEventListener('click', () => triggerAchievement(3));
